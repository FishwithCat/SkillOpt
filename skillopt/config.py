...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "model.deepseek_base_url": "deepseek_base_url",
    "model.deepseek_api_key": "deepseek_api_key",
    "model.optimizer_deepseek_base_url": "optimizer_deepseek_base_url",
    "model.optimizer_deepseek_api_key": "optimizer_deepseek_api_key",
    "model.target_deepseek_base_url": "target_deepseek_base_url",
    "model.target_deepseek_api_key": "target_deepseek_api_key",
